...
<section>
    <div class="grid gap-x-10 gap-y-2 items-center" style="grid-template-columns: {{$tableCols}};">
        ...
        <span class="text-right">{!! format_money_pdf($item->price, $invoice->customer->currency) !!}</span>
        @if($invoice->discount_per_item == 'YES')
    ...
    <div class="flex justify-end break-inside-avoid">
        <div class="grid gap-y-2 gap-x-6" style="grid-template-columns: max-content max-content;">
            ...
            <span class="text-right">{!! format_money_pdf($invoice->sub_total, $invoice->customer->currency) !!}</span>
            ...
            <span class="text-orange-700 text-right">{!! format_money_pdf($invoice->total, $invoice->customer->currency) !!}</span>
        </div>
    </div>
</section>
